package com.ptithcm.group9.moneytor.ui.login;
...
import com.ptithcm.group9.moneytor.ui.main.MainActivity;
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(LoginActivity.this, "signInWithCredential:success:",
                                            Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(LoginActivity.this, "signInWithCredential:fail:",
                                            Toast.LENGTH_SHORT).show();
